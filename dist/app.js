...
class ProjectState extends State {
    ...
    addProject(title, description, numOfPeple) {
...
class Component {
    ...
    attach(insertAtBegginng) {
        this.hostElement.insertAdjacentElement(insertAtBegginng ? "afterbegin" : "beforeend", this.element);
    }
}
